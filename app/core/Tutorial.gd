...
const SCENE_MAIN := "res://app/main_menu/main_scene.tscn"
const SCENE_CREATE := "res://app/assembly/create_dron.tscn"
const SCENE_LEVEL_SELECT := "res://app/ui/game_level.tscn"
const SCENE_SHOP := "res://app/shop/shop.tscn"
